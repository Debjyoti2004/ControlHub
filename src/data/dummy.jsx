...
export const EditorData = () => (
  <div>
    <h3>
      I am Debjyoti Shit, a Full Stack Cloud Developer with expertise in building scalable and high-performance applications. I specialize in leveraging AWS, React, and Node.js to create cloud-native solutions that meet modern business needs.

      I have a proven track record of optimizing cloud infrastructure through DevOps practices and CI/CD pipelines, enabling faster and more reliable deployments. With strong skills in Next.js and MongoDB, I design secure, scalable applications that provide seamless user experiences.

      I also implement robust authentication systems and integrate automated testing frameworks to deliver error-free solutions that reduce deployment times while maintaining top security standards. My focus is always on performance, scalability, and cost-efficiency, ensuring the applications I develop are future-ready.

      I am passionate about continuous learning and staying updated with emerging technologies, allowing me to deliver innovative and forward-thinking solutions.
    </h3>
  </div>
);
